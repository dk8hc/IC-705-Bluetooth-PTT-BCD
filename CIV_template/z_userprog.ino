...
#define PTTpinVHF 26       //PTT out VHF
#define PTTpinUHF 26       //PTT out UHF

#define BCDA 33            //BCD Pin A
#define BCDB 32            //BCD Pin B
#define BCDC 22            //BCD Pin C
#define BCDD 17            //BCD Pin D
...
void  userSetup() {
    ...
    pinMode(BCDA, OUTPUT);      //BCDA out pin
    pinMode(BCDB, OUTPUT);      //BCDB out pin
    pinMode(BCDC, OUTPUT);      //BCDC out pin
    pinMode(BCDD, OUTPUT);      //BCDD out pin
